...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    private List<modelDoc> userList;
    Context context;

    public Adapter (List<modelDoc>userList, Context context)
    ...
    public void onBindViewHolder(@NonNull Adapter.ViewHolder holder, int position) {
        final modelDoc temp =userList.get(position);
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("imagename", temp.getImageview1());
                intent.putExtra("name", temp.getTextview1());
                intent.putExtra("time", temp.getTextview2());
                intent.putExtra("mssg", temp.getTextview3());
